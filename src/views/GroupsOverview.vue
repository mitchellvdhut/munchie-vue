...
import sadMunchie from '@/assets/images/sad_munchie.png';
</script>
...
<template>
  ...
  <Image
    ...
    width="150"
    class="m-auto mt-36 mb-12"
  />
  <h1 class="p-3 text-center font-semibold text-2xl text-gray-500">
